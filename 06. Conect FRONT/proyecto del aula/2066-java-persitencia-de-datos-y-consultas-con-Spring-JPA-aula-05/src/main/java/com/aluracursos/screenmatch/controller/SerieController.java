...
public class SerieController {
    ...
    public List<SerieDTO> obtenerRecientes () {
    ...
    public List<SerieDTO> obtenerSeriesCategoria (@PathVariable String categoria){
        return service.obtenerSeriesCategoria(categoria);
    }
}
